...
gulp.task( 'stylesheets', function() {
  return gulp.src( 'source/assets/stylesheets/*.scss' ) // Get all *.scss files
...
gulp.task( 'watch', function() {
  gulp.watch( 'source/assets/stylesheets/**/*.scss', gulp.series( 'stylesheets' ) ); // Watch for SCSS changes
  gulp.watch( 'source/assets/images/**/*', gulp.series( 'images' ) ); // Watch for image changes
  gulp.watch( 'source/**', gulp.series( 'kss' ) ); // Watch for style guide changes
  gulp.watch( 'build/**.html', browserSync.reload );
  gulp.watch( 'styleguide/**.html', browserSync.reload );
} );

gulp.task( 'default', gulp.parallel( 'watch', [ 'stylesheets', 'images', 'kss' ] ) );
